...
const contactItems = [
  ...
  { label: 'Tel', value: '07958 600250 / 07817 176637', href: 'tel:07958600250' },
  { label: 'Website', value: 'www.shongoshomithi.co.uk', href: 'https://www.shongoshomithi.co.uk' },
  ...
  return (
    <>
      <PageHero
        landmark="padma"
        subtitle="Contact"
        title="Get in touch with Shongo Shomithi"
        description="Contact the team for sponsorship, stalls, partnerships, community engagement and general event enquiries."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-8 lg:grid-cols-[1fr_0.9fr] items-start">
          <div>
            <SectionTitle
              ...
              title="Let’s build a lasting community celebration together"
              description="Whether you want to become a sponsor, apply for a stall or simply connect with the organisers, the Shongo Shomithi team is ready to help."
            />
          ...
          <div className="rounded-3xl bg-mela-green-dark text-white p-6 md:p-8 shadow-xl h-fit lg:sticky lg:top-32">
            <p className="font-sub text-mela-gold text-xl mb-3">Event Summary</p>
            <h3 className="font-display text-4xl mb-5 leading-[1.12] text-balance">Walsall’s First Ever Bangla Community Day 2026</h3>
