...
export default function Footer() {
  return (
    <footer className="bg-mela-green text-white/90">
      {/* Main Footer */}
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Walsall, West Midlands<br />United Kingdom
                </span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@shongoshomithi.com" className="hover:text-mela-gold transition-colors">
                  info@shongoshomithi.com
                </a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-mela-gold shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
